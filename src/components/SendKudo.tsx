    ...
    <div className="w-full min-w-0">
      {!open ? (
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-rose-500 to-orange-500 px-5 py-2.5 text-sm font-semibold text-white shadow-md transition-all hover:from-rose-600 hover:to-orange-600 hover:shadow-lg sm:w-auto"
        >
        ...
        <form
          ...
          className="w-full min-w-0 rounded-2xl border border-rose-100 bg-white dark:bg-zinc-900 p-4 shadow-sm sm:p-5"
        >
